...
function Header({ isMembers = false, style = { background: "rgba(242, 240, 234, 0.218)" } }) {
    ...
    const popupStyle = {
        ...
        backgroundColor: '#ffffff', padding: '12px 20px', borderRadius: '12px',
        boxShadow: '0 10px 40px rgba(0,0,0,0.15)', border: '1px solid rgba(0,0,0,0.05)',
        display: 'flex', flexDirection: 'row', gap: '20px', zIndex: 1000,
        minWidth: 'max-content', alignItems: 'center',
        opacity: showSocials ? 1 : 0, visibility: showSocials ? 'visible' : 'hidden',
        transition: 'all 0.2s ease-in-out', marginTop: showSocials ? '0' : '-10px'
    };

    const arrowStyle = {
        position: 'absolute', top: '-6px', left: '50%', marginLeft: '-6px',
        width: '12px', height: '12px', backgroundColor: '#ffffff', transform: 'rotate(45deg)',
        borderLeft: '1px solid rgba(0,0,0,0.05)', borderTop: '1px solid rgba(0,0,0,0.05)',
    };
    ...
    return (
        <div className="hed">
            <header 
                ...
                style={{ 
                    ...style, 
                    // This perfectly tucks it right below the dynamic island/notch
                ...
                <nav className="navbar">
                    <div className="container">
                        <div className="nav-brand">
                            <div className="logo-container" onClick={toggleSocials} style={{ cursor: 'pointer', position: 'relative' }} title="Click to view Social Media">
                            ...
                            <div className="brand-info">
                                <span className="brand-text" style={{ color: isMembers ? "white" : undefined, fontWeight: isMembers ? "100" : undefined }}>
